...
namespace Config
{
    public class JointConfig : object
    {
        ...
        */
        ...
        public GeneVariable AngleConstraint = new GeneVariable(new Vector3(120, 120, 120), 0, 120, Variable.AngleConstraint);

        //when rotating how much force should each axis have applied to it?
        //e.g. 0.5, 1, 0.5 makes y the primary axis
        [Tooltip("Range 0 <= x <= 1")]
        public GeneVariable RotationMultiplier = new GeneVariable(new Vector3(0.5f, 1f, 0.5f), 0f, 1f, Variable.RotationMultiplier);

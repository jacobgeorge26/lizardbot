...
namespace Config
{
    public class BodyConfig : JointConfig
    {
        ...
        public GeneVariable IsRotating = new GeneVariable(true, Variable.Movement);

        //will this section use sin or cos in the oscillation?
        [HideInInspector]
        public GeneVariable UseSin = new GeneVariable(true, Variable.Movement);

        /*-------------------------------------------------------------------------------------------------------*/

        //will this section be driving (it can rotate AND drive if that is desirable)
        public GeneVariable IsDriving = new GeneVariable(true, Variable.Movement);
        ...
        [Range(0, 3)]
        public GeneVariable DriveVelocity = new GeneVariable(2f, 0f, 3f, Variable.Movement);

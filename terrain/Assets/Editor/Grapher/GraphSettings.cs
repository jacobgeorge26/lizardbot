...
namespace NWH
{
    ...
    public static class GraphSettings
    {
        ...
        // Colors
        public static Color32 windowBackgroundColor = new Color32(255, 255, 255, 255);
        ...
        public static Color32 ruleLineColor = new Color32(0, 0, 0, 100);
        public static Color32 gridLineColor = new Color32(0, 0, 0, 80);
        ...
        public static float HorizontalResolution
        {
            get
            {
                return EditorPrefs.GetFloat("GrapherHorizontalResolution", 60);
            }
            set
            {

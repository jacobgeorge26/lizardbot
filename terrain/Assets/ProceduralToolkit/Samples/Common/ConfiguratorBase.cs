...
namespace ProceduralToolkit.Samples
{
    public class ConfiguratorBase : MonoBehaviour
    {
        ...
        {
            currentPalette.skyColor = ToHSV(new Color(0.53f, 0.81f, 0.92f));
        ...
        public static ColorHSV ToHSV(Color rgb)
        {
            Vector3 hcv = RGBtoHCV(rgb);
            float s = hcv.y / (hcv.z + float.Epsilon);
        ...
        private static Vector3 RGBtoHCV(Color rgb)
        {
            ...
            float h = Mathf.Abs((q.w - q.y) / (6 * c + float.Epsilon) + q.z);
        ...
        private class Palette
        {
            ...
            public ColorHSV skyColor = ToHSV(Color.white);
            public ColorHSV horizonColor = ToHSV(Color.white);
            public ColorHSV groundColor = ToHSV(Color.white);
        }
    }
}
